...
const seoPages = [
  ...
  "/self-reflection-app-understanding-patterns",
  "/app-to-understand-yourself-over-time",
  "/ai-reflection-notice-patterns-over-time",
  "/mood-tracking-vs-self-reflection",
  "/journaling-vs-self-reflection",
  "/reflect-without-long-journal-entry",
  "/what-makes-self-reflection-app-useful-long-term",
